import numpy as np
from utils import get_movements_4n, get_movements_8n, get_movements_26n, heuristic, Vertices, Vertex
...
class OccupancyGridMap:
    def __init__(self, x_dim, y_dim, z_dim, exploration_setting='26N'):
        """
    ...
    def in_bounds(self, cell: (int, int, int)) -> bool:
        ...
        :param cell: cell position (x,y,z)
    ...
    def succ(self, vertex: (int, int, int), avoid_obstacles: bool = False) -> list:
        """
        ...
        if self.exploration_setting == '4N': 
            movements = get_movements_4n(x=x, y=y, z=z)
        elif self.exploration_setting == '8N':
            movements = get_movements_8n(x=x, y=y, z=z)
        else:
            movements = get_movements_26n(x=x, y=y, z=z)
